...
| 项目 | 内容                                                                                                                                                                                                           |
| ---- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 状态 | MVP（M0–M3）已完成；M4（一）已完成（2026-09-16，契约 `docs/M4-CONTRACT.md`），M4（二）待做；M5（一）正文块与内联前端已完成（2026-09-17，契约见 `apps/web/src/themes/README.md` §10）；进度见 §四末「进度记录」 |
| 版本 | v0.5（2026-09-17）                                                                                                                                                                                             |
...
| **M5 前端卡与酒馆助手**（约 3 周） | 沙箱与信任级别、RPC、状态镜像、酒馆助手 shim、事件映射、MVU 引擎、变量面板、脚本库（**正文块与内联 HTML 前端已提前完成**，剩下要跑脚本的那一半）                       | 社区 Top 20 前端卡中 ≥ 15 张开箱可用；5 张流行 MVU 卡零修改可用                                                    |
