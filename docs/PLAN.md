...
| 项目 | 内容                                                                                                                                                                                                           |
| ---- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 状态 | MVP（M0–M3）已完成；M4（一）已完成（2026-09-16，契约 `docs/M4-CONTRACT.md`），M4（二）待做；M5（一）正文块与内联前端、M5（二）前端卡运行时 / 酒馆助手兼容 / MVU 已完成（2026-09-17，契约 `docs/M5-CONTRACT.md`）；进度见 §四末「进度记录」 |
| 版本 | v0.6（2026-09-17）                                                                                                                                                                                             |
